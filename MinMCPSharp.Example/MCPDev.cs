namespace MinMCPSharp.Example
{
    ...
    public class MCPDev
    {
        ...
        ///<summary>returns the input string back</summary>
        ...
        /// </summary>
        [McpTool]
        public static string AddComplex(ComplicatedObject obj) =>
            $"Name: {obj.Name}, Age: {obj.Age}, Hobbies: {string.Join(", ", obj.Hobbies)}";

        /// <summary>
        /// throws an exception - for ensuring we handle them gracefully
        /// </summary>
        [McpTool("throw_exception")]
