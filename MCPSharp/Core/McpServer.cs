...
namespace MCPSharp
{
    ...
    public class McpServer : IDisposable
    {
        ...
        public McpServer(string name = "MCPSharp", string version = "1.0.0")
        {
            ServerName = name;
        ...
        public McpServer RegisterAssembly(Assembly assembly)
        {
            ...
            foreach (var type in types)
            {
                ...
                Log("[MCPSharp] Registered: " + type.Name);
            }
            ...
            string endpoint = "localhost", int port = 8080)
        {
            ...
            Log(string.Format("[MCPSharp] Started ({0}) on {1}:{2}",
