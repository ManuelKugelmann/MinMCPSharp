...
namespace SharpMinMCP
{
    ...
    /// </summary>
    [AddComponentMenu("SharpMinMCP/MCP Server")]
    public class McpServerBehaviour : MonoBehaviour
    {
        [Header("Server Config")]
        [SerializeField] private string serverName = "SharpMinMCP";
        ...
        /// <summary>Access the underlying plain-C# server.</summary>
        public McpServer Server => _server;
        public bool IsRunning => _server != null && _server.IsRunning;

        // ── Static factory ───────────────────────────────────────────

        public static McpServerBehaviour Create(string name = "SharpMinMCP",
            string version = "1.0.0", int port = 8080)
        {
            var go = new GameObject("[SharpMinMCP-Server]");
