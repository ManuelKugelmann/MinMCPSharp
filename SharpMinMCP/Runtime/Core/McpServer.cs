...
namespace SharpMinMCP
{
    ...
    public class McpServer : IDisposable
    {
        ...
        public McpServer(string name = "SharpMinMCP", string version = "1.0.0")
        {
            ServerName = name;
        ...
        public McpServer RegisterAssembly(Assembly assembly)
        {
            ...
            foreach (var type in types)
            {
                ...
                Log("[SharpMinMCP] Registered: " + type.Name);
            }
            ...
            string endpoint = "localhost", int port = 8080)
        {
            ...
            {
                Log("[SharpMinMCP] Already running");
                return this;
            }
            ...
            Log(string.Format("[SharpMinMCP] Started ({0}) on {1}:{2}",
