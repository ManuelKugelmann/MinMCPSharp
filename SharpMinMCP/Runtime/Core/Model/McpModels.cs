...
// Consolidated model types. Newtonsoft.Json only.
...
namespace SharpMinMCP
{
    ...
    public class McpParameterSchema
    {
        ...
        /// <summary>For complex object types, inline JSON Schema of properties.</summary>
    ...
    {
        [JsonProperty("name")]    public string Name = "SharpMinMCP";
