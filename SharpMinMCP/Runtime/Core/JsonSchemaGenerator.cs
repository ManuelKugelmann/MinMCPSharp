...
// Replaced: AIJsonUtilities.CreateJsonSchema → manual walker
// Removed: SemanticKernel, System.Text.Json
using System;
...
{
    /// <summary>
    /// Maps C# types to JSON Schema. Replaces Microsoft.Extensions.AI dependency.
    /// </summary>
    internal static class JsonSchemaGenerator
    {
        ...
        public static JObject GenerateObjectSchema(Type type)
        {
            ...
            if (jsonType != "object") return null; // primitives don't need expansion
